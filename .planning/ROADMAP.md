...
- [ ] **Phase 1: Project Scaffold & Audio Pipeline** - Build system, APVTS parameter tree, processBlock skeleton with mix/output and real-time safety
- [ ] **Phase 2: Cabinet Resonance** - First DSP stage (Stage I) with short FDN, three cabinet types, validates section interface
...
|-------|----------------|--------|-----------|
| 1. Project Scaffold & Audio Pipeline | 0/0 | Not started | - |
| 2. Cabinet Resonance | 0/0 | Not started | - |
